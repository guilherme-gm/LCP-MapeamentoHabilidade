 ...
 * @author guilh
 */
public class DoCancelarProjeto implements ICommand {

    @Override
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) {
        long id = Long.parseLong(request.getParameter("idProjeto"));
        
        ProjetoDAO projetoDao = new ProjetoDAOImpl();
        projetoDao.cancela(id);
        
        request.setAttribute("msg_tipo", "alert-success");
        request.setAttribute("msg", "Projeto cancelado com sucesso");
